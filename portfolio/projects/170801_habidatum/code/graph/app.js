var App = (function () {
    function App() {
        ...
        this.layoutA = new Layouts.Layout5(this.canvas, this.private_graph.component, new TestComponent(), 0, new TestComponent(), 0, this.timeline.component, 100, new TestComponent(), 0);
    }
