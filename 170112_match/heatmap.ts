...
class App {
    ...
    on_data_load(player) {
        ...
        const h1 = 32, w1 = Math.round(h1 * ratio),
        ...
        // let buf2 = new GaussConvolutionBuffer(buf1).blur(8, 4);
        // let r = 9, b = 0.6;
        ...
        let quant_e = new QuantBuffer(buf2e, 0, 10);
        // let quant_e1 = new QuantBuffer(buf2e, 0, 6);
        // let contour_e = new EdgeDetector(quant_e1);
        let composition = new CompositionCanvas(this.canvas)
            ...
            .draw_buffer(buf1, (
                ...
                return;
                if (val == 0) return;
                let t = quant_e.at(x, y) / quant_e.levels;
                // ctx.strokeStyle = t < 0.5 ? 'black' : 'white';
